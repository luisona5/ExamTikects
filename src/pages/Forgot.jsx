...
export const Forgot = () => {
    ...
    return (
        <div className="flex flex-col sm:flex-row h-screen">
            ...
            <div className="w-full sm:w-1/2 h-screen bg-white flex justify-center items-center">
                ...
                <div className="md:w-4/5 sm:w-full">
                    ...
                    <form onSubmit={handleSubmit(sendMail)}>
                        ...
                        <div className="mb-3">
                            <button className="bg-blue-900 text-white border py-2 w-full rounded-xl mt-5 hover:scale-105 duration-300 hover:bg-gray-900 hover:text-white">Enviar correo 
                            </button>
                        </div>
                    ...
                    <div className="mt-3 text-sm flex justify-between items-center">
                        ...
                        <Link to="/login" className="py-2 px-5 bg-blue-900 text-white border rounded-xl hover:scale-110 duration-300 hover:bg-gray-900 hover:text-white">Iniciar sesión</Link>
            ...
            <div className="w-full sm:w-1/2 h-1/3 sm:h-screen bg-[url('/public/images/buho_e.jpeg')] 
