import buhoLost from '../assets/buholost.jpg'
...
export const Forbidden = () => {
    return (
        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <img className="object-cover h-80 w-80 rounded-full border-4 border-solid border-slate-600" src={buhoLost} alt="image description" />
